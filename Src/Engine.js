...
Engine.prototype.RenderLights = function() {
	...
	for(let i = 0; i < this.Lights.length; i++) {
		if(this.Lights[i]._isDirectional) {
...
Engine.prototype.RenderMesh = function(Mesh, matrix) {
	...
	//this.gl.uniform3fv(programInfo.uniformLocations.lightDirections, this.DirectionalLightData);
	
	/* Set ALL Active Lights In Engine (all active lights effect mesh) */
	this.gl.uniform1i(programInfo.uniformLocations.numbPointLights, 2);
	this.gl.uniform3fv(programInfo.uniformLocations.pointLights, [0, -10, 0, 0, 10, 0]);
