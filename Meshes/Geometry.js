...
/* Update All Geometry */
Geometry.prototype.UpdateGeometry = function() {
...
Geometry.prototype.SetBufferPositions = function() {
	...
	for(let i = 0; i < this.positions.length; i+=3) {
		this.positions[i] /= this._mesh._scale.x;
		this.positions[i+1] /= this._mesh._scale.y;
		this.positions[i+2] /= this._mesh._scale.z;
		
		this.positions[i] *= this._mesh.scale.x;
		this.positions[i+1] *= this._mesh.scale.y;
		this.positions[i+2] *= this._mesh.scale.z;
	}
